package com.example.restapi_dipti_15.Adapter15
...
import com.example.restapi_dipti_15.R



class ProductAdapter15(private val products:List<Product>):RecyclerView.Adapter<ProductAdapter15.ProductViewHolder>() {
